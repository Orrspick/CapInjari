        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form action="MemberDetailupAction.do" method="post">
                    ...
                    <div class="form-group"><label>전화번호</label><input class="form-control" type="text" name="phone"></div>
                    <div class="form-group"><label>주소</label><input class="form-control" type="text" name="address"></div>
                    <div class="form-group"><label>전공</label><input class="form-control" type="text" name="major"></div>
                    <div class="form-group"><label>경력</label>
                        <div>
                            <fieldset>
                                ...
                                <div id="select_div" style="display: none;"><select class="form-control" style="width:176px" id="select_career" name="career_year"><option value="0" selected>선택해주세요</option><option value="1">1년 이하</option><option value="2">1년 이상</option><option value="3">2년 이상</option><option value="4">3년 이상</option><option value="5">5년 초과</option></select></div>
                                <div></div>
                            </fieldset>
                        </div>
                    </div>
