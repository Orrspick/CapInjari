        ...
        <section class="clean-block clean-product dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">${detailinfo.cname }</h2>
                    <p></p>
                </div>
                <div class="block-content">
                    <div class="product-info">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info">
                                    <h3>${detailinfo.cname }</h3>
                                    <div class="price"></div><button class="btn btn-primary" type="button">가상면접</button>
                                    <div class="summary">
                                        <p>동영상, 음성 가상면접 이용가능<br><br>전화번호 :&nbsp;</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-info">
                        <div>
                            <ul class="nav nav-tabs" role="tablist" id="myTab">
                                <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-toggle="tab" id="description-tab" href="#description">회사정보</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-toggle="tab" id="specifications-tabs" href="#specifications">가상면접정보</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-toggle="tab" id="reviews-tab" href="#reviews">코멘트</a></li>
                            </ul>
